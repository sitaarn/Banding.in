      ...
      navButtons.innerHTML = `
        <div class="user-chip-wrap" id="userChipWrap">
          ...
          <div class="user-dropdown">
            ...
            <a class="dropdown-item" href="http://localhost/hello-world/search">
        ...
        <button class="nav-btn" onclick="window.location.href='http://localhost/hello-world/landing'">Home</button>
      `;
    } else {
      navButtons.innerHTML = `
