...
<body>
  ...
  <nav>
    <span class="nav-brand" onclick="window.location.href='http://localhost/hello-world/landing'">Banding<em>.in</em></span>
  ...
  <div class="page" id="search">
    <div class="search-wrapper">
      <div class="search-brand" onclick="window.location.href='http://localhost/hello-world/landing'">Banding<em>.in</em></div>
