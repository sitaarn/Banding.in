    ...
    <div class="nav-links" id="navLinks">
      <!-- Akan diisi JavaScript -->
        ...
        <button class="nav-btn favorite-nav-btn"
                onclick="window.location.href='http://localhost/hello-world/favorit'">
          ❤️ Favorit Saya
        </button>
    ...
    <div class="search-wrapper">
      ...
      <div class="most-searched" id="mostSearched">
        ...
        <div class="most-searched-tags">
          ...
          <span class="ms-tag" onclick="fillSearch('Laptop Asus')"><span class="ms-tag-icon">💻</span> Laptop Asus</span>
    ...
    <div class="listing-shell">
      ...
      <aside class="ls-sidebar">
        ...
        <div class="ls-panel">
          ...
          <div class="ls-sort-row"    data-sort="newest"    onclick="lsSetSort(this)"><span class="ls-sort-icon">✦</span> Terbaru</div>
          <div class="ls-sort-row"    data-sort="rating"    onclick="lsSetSort(this)"><span class="ls-sort-icon">★</span> Rating</div>
        </div>
